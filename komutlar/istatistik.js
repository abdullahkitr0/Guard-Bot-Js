...
const istatistikler = new Discord.MessageEmbed()
  ...
  .addField(`:incoming_envelope: » Yapımcım` ,`<@407927195919450113>`,true)
 ...
 .addField(`» Linkler`, `[Destek Sunucusu](https://discord.gg/KERamBW) | `, true)
...
exports.help = {
  name: 'i',
  description: 'İstatistikleri Gösterir',
  usage: 'istatistik'
}; 